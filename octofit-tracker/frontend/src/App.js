          ...
          <Route path="/" element={
            <div className="card text-center">
              ...
              <div className="card-body">
                ...
                <Link className="btn btn-warning m-2" to="/teams">View Teams</Link>
                <Link className="btn btn-secondary m-2" to="/users">View Users</Link>
                <Link className="btn btn-danger m-2" to="/workouts">View Workouts</Link>
              </div>
            </div>
          } />
        </Routes>
